...
3. **Read-model widget choice** — ~~E5-S2 ships exactly one of {conversion funnel, per-subsidiary roll-up}; pick during sprint planning.~~ **RESOLVED 2026-06-07 → the conversion funnel** (the Claude Design prototype built and shipped it; DEC-UX-7). E5-S2 ships the funnel; the per-subsidiary roll-up remains the separate E1-S5 surface. *(No sprint-planning decision remains.)*
